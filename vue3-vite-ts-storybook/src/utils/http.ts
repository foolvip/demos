...
const ajax = (type: string, url: string, params?: object, headers?: object, config?: {codeAllPass?: boolean}) => {
    let reqParams = {}
...
export default {
    axios: axiosInstance,
    get: (url: string, params?: object, headers?: object, config?: object) => ajax('get', url, params, headers, config),
    post: (url: string, params?: object, headers?: object, config?: object) => ajax('post', url, params, headers, config),
