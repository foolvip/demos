<template>
  <!-- 左侧所有组件的展示列表 -->
  <content-box class="snail-content-charts" :class="{ scoped: !getCharts }" title="组件" :depth="1" :backIcon="false">
    <template #icon>
    ...
    <aside>
      <div class="menu-width-box">
        ...
        <!-- <div class="menu-component-box">
          <snail-skeleton :load="!selectOptions" round text :repeat="2" style="width: 90%"></snail-skeleton>
